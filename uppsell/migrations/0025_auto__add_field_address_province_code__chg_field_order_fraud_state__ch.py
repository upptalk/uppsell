...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Address.province_code'
        db.add_column('addresses', 'province_code',
    ...
    def backwards(self, orm):
        # Deleting field 'Address.province_code'
        db.delete_column('addresses', 'province_code')


        # Changing field 'Order.fraud_state'
        db.alter_column('orders', 'fraud_state', self.gf('django.db.models.fields.CharField')(default='init', max_length=30))
