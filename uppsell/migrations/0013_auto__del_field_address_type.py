...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Address.type'
        db.delete_column('addresses', 'type')


    def backwards(self, orm):
        # Adding field 'Address.type'
        db.add_column('addresses', 'type',
                      self.gf('django.db.models.fields.CharField')(default='billing', max_length=10),
                      keep_default=False)
