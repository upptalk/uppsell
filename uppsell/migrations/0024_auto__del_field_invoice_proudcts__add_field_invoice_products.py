...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Invoice.products'
        db.add_column('invoices', 'products',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Invoice.proudcts'
        raise RuntimeError("Cannot reverse this migration. 'Invoice.proudcts' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Invoice.proudcts'
        db.add_column('invoices', 'proudcts',
                      self.gf('django.db.models.fields.CharField')(max_length=2000),
                      keep_default=False)

        # Deleting field 'Invoice.products'
        db.delete_column('invoices', 'products')
