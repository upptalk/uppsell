...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SalesTaxRate'
        db.create_table(u'uppsell_salestaxrate', (
        ...
        db.send_create_signal(u'uppsell', ['SalesTaxRate'])

        # Deleting field 'Store.sales_tax_rate'
        db.delete_column('stores', 'sales_tax_rate')


    def backwards(self, orm):
        # Deleting model 'SalesTaxRate'
        db.delete_table(u'uppsell_salestaxrate')

        # Adding field 'Store.sales_tax_rate'
        db.add_column('stores', 'sales_tax_rate',
    ...
    models = {
        ...
        u'uppsell.product': {
            ...
            'features': ('django.db.models.fields.CharField', [], {'max_length': '10000', 'blank': 'True'}),
