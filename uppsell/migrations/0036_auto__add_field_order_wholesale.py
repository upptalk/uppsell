...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.wholesale'
        db.add_column('orders', 'wholesale',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.wholesale'
        db.delete_column('orders', 'wholesale')
    ...
    models = {
        ...
        u'uppsell.order': {
            ...
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'wholesale': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
