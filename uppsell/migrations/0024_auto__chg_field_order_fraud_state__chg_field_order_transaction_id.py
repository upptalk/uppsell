...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Order.fraud_state'
        db.alter_column('orders', 'fraud_state', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

        # Changing field 'Order.transaction_id'
        db.alter_column('orders', 'transaction_id', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Order.fraud_state'
        raise RuntimeError("Cannot reverse this migration. 'Order.fraud_state' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Order.fraud_state'
        db.alter_column('orders', 'fraud_state', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Changing field 'Order.transaction_id'
        db.alter_column('orders', 'transaction_id', self.gf('django.db.models.fields.CharField')(default='', max_length=200))
