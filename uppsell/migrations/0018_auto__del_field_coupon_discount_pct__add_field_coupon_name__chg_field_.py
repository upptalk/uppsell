...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Coupon.discount_pct'
        db.delete_column('coupons', 'discount_pct')

        # Adding field 'Coupon.name'
        db.add_column('coupons', 'name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Coupon.product'
        db.alter_column('coupons', 'product_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['uppsell.Product'], null=True))

        # Changing field 'Coupon.valid_from'
        db.alter_column('coupons', 'valid_from', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Coupon.store'
        db.alter_column('coupons', 'store_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['uppsell.Store'], null=True))

    def backwards(self, orm):
        # Adding field 'Coupon.discount_pct'
        db.add_column('coupons', 'discount_pct',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Coupon.name'
        db.delete_column('coupons', 'name')


        # Changing field 'Coupon.product'
        db.alter_column('coupons', 'product_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['uppsell.Listing'], null=True))

        # Changing field 'Coupon.valid_from'
        db.alter_column('coupons', 'valid_from', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Coupon.store'
        db.alter_column('coupons', 'store_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['uppsell.Store']))
