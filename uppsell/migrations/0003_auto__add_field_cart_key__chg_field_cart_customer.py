...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cart.key'
        db.add_column('carts', 'key',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=40),
                      keep_default=False)


        # Changing field 'Cart.customer'
        db.alter_column('carts', 'customer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['uppsell.Customer'], null=True))

    def backwards(self, orm):
        # Deleting field 'Cart.key'
        db.delete_column('carts', 'key')
        ...
        # Changing field 'Cart.customer'
        db.alter_column('carts', 'customer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['uppsell.Listing']))
