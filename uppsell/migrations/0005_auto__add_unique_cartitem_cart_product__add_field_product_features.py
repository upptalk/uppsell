...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_unique('cart_items', ['cart_id', 'product_id'])

        # Adding field 'Product.features'
        db.add_column('products', 'features',
    ...
    def backwards(self, orm):
        ...
        db.delete_unique('cart_items', ['cart_id', 'product_id'])

        # Deleting field 'Product.features'
        db.delete_column('products', 'features')
