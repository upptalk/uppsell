...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Listing.features'
        db.alter_column('listings', 'features', self.gf('django.db.models.fields.CharField')(max_length=10000, null=True))
        # Adding field 'Product.has_stock'
        db.add_column('products', 'has_stock',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'Product.features'
        db.alter_column('products', 'features', self.gf('django.db.models.fields.CharField')(max_length=10000, null=True))

    def backwards(self, orm):

        # Changing field 'Listing.features'
        db.alter_column('listings', 'features', self.gf('django.db.models.fields.CharField')(default='', max_length=10000))
        # Deleting field 'Product.has_stock'
        db.delete_column('products', 'has_stock')


        # Changing field 'Product.features'
        db.alter_column('products', 'features', self.gf('django.db.models.fields.CharField')(default='', max_length=10000))
