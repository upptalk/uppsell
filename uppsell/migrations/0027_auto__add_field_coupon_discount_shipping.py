...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Coupon.discount_shipping'
        db.add_column('coupons', 'discount_shipping',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Coupon.discount_shipping'
        db.delete_column('coupons', 'discount_shipping')
