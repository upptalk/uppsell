...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Listing.tax_rate'
        db.add_column('listings', 'tax_rate',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['uppsell.SalesTaxRate']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Listing.tax_rate'
        db.delete_column('listings', 'tax_rate_id')
