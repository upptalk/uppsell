...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('orders', 'order_total')

        # Deleting field 'Order.order_shipping_total'
        db.delete_column('orders', 'order_shipping_total')


    def backwards(self, orm):
        # Adding field 'Order.order_total'
        db.add_column('orders', 'order_total',
                      self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=8, decimal_places=2),
                      keep_default=False)

        # Adding field 'Order.order_shipping_total'
        db.add_column('orders', 'order_shipping_total',
                      self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=8, decimal_places=2),
                      keep_default=False)
