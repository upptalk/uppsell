...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('customers', 'last_name')

        # Deleting field 'Customer.first_name'
        db.delete_column('customers', 'first_name')

        # Adding field 'Customer.title'
        db.add_column('customers', 'title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True),
                      keep_default=False)

        # Adding field 'Customer.full_name'
        db.add_column('customers', 'full_name',
    ...
    def backwards(self, orm):
        ...
        db.add_column('customers', 'last_name',
                      self.gf('django.db.models.fields.CharField')(blank=True, default='', max_length=30, db_index=True),
                      keep_default=False)

        # Adding field 'Customer.first_name'
        db.add_column('customers', 'first_name',
                      self.gf('django.db.models.fields.CharField')(blank=True, default='', max_length=30, db_index=True),
                      keep_default=False)

        # Deleting field 'Customer.title'
        db.delete_column('customers', 'title')

        # Deleting field 'Customer.full_name'
        db.delete_column('customers', 'full_name')
