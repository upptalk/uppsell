...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('listings', 'price', self.gf('django.db.models.fields.DecimalField')(max_digits=24, decimal_places=12))

        # Changing field 'Listing.shipping'
        db.alter_column('listings', 'shipping', self.gf('django.db.models.fields.DecimalField')(max_digits=24, decimal_places=12))

        # Changing field 'SalesTaxRate.rate'
        db.alter_column(u'uppsell_salestaxrate', 'rate', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=5))

    def backwards(self, orm):

        # Changing field 'Listing.price'
        db.alter_column('listings', 'price', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=2))

        # Changing field 'Listing.shipping'
        db.alter_column('listings', 'shipping', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=2))

        # Changing field 'SalesTaxRate.rate'
        db.alter_column(u'uppsell_salestaxrate', 'rate', self.gf('django.db.models.fields.FloatField')())
