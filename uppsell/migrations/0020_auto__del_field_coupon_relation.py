...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Coupon.relation'
        db.delete_column('coupons', 'relation')


    def backwards(self, orm):
        # Adding field 'Coupon.relation'
        db.add_column('coupons', 'relation',
                      self.gf('django.db.models.fields.CharField')(default='discount', max_length=16),
                      keep_default=False)
