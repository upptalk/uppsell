...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Invoice.username'
        db.add_column('invoices', 'username',
                      self.gf('django.db.models.fields.CharField')(default='unknown', max_length=100),
                      keep_default=False)

        # Adding field 'Invoice.order_state'
        db.add_column('invoices', 'order_state',
    ...
    def backwards(self, orm):
        # Deleting field 'Invoice.username'
        db.delete_column('invoices', 'username')

        # Deleting field 'Invoice.order_state'
        db.delete_column('invoices', 'order_state')
